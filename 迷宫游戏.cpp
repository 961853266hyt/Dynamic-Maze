...
void MainMenu(){
	...
	switch(choice){
		case 1: system("cls");
				printf("\n*******************************************");
				printf("\n请输入一个不超过100的正整数代表迷宫的宽度：");
				scanf("%d",&l); 
				printf("\n请输入一个不超过100的正整数代表迷宫的高度：");
				scanf("%d",&w);
				printf("\n请输入一个小于100的正整数代表墙的比例（建议选择25-35之间）:");
				scanf("%d",&prop);
...
姓名：胡逸藤
学号：18041513
github链接:https://github.com/961853266hyt/Dynamic-Maze
*/
